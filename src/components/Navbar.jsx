...
const navbar = ({
  ...
  return (
    <nav className="flex flex-col justify-between bg-white dark:bg-gray-800 shadow-md h-auto  p-4 w-full">
      <div className="flex justify-between items-center justify-items-center bg-red-30">
        <div className=" hidden sm:flex items-center gap-4 md:gap-10 pl-4">
          <Link
            to="/"
            className="text-red-500 hover:text-red-600 text-3xl ml-20 "
          >
            <FaYoutube />
          </Link>
        </div>
        ...
        />
        <button
          className="flex items-center justify-center mr-3 sm:mr-6 w-12 h-12 rounded-full border
