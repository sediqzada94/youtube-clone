...
const PlaylistCard = ( { playlist } ) => {
    ...
    const postion = {
      ...
      return (
        ...
        <Link to={`/playlist-detail/${playlist?.id?.playlistId}`} className='group relative mx-auto'>
        ...
        <div className=' flex justify-center w-full'>
             <Link to={`/playlist-detail/${playlist?.id?.playlistId}`} className='flex items-center transition-all text-sm text-left text-gray-600
